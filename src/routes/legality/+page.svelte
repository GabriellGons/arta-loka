...
<svelte:head>
  <title>Legality — PT Arta Loka Wisala</title>
  <meta
    name="description"
...
<section class="about-hero" aria-label="About Us Hero">
  <div class="about-hero-inner">
    ...
    <h1 class="hero-headline">Trust. Compliance. Accountability.</h1>
    <p class="hero-sub">
      Setiap kerja sama dijalankan di atas dasar legalitas dan kepatuhan yang
      jelas.
    </p>
  </div>
</section>
    ...
    <div class="legality-grid">
      ...
      <div class="legality-card">
        <div class="legality-card-top">
          ...
          <p class="legality-card-desc">Nomor pokok wajib pajak perusahaan.</p>
        </div>
        <span class="status-tag verified">VERIFIED</span>
      </div>
